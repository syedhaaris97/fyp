...
<body>
              ...
              <div class="card">
                <div class="col-md-12">
                 <div class="table-responsive py-4">
                   <center><h2>Stop Data Record</h2></center>  
 ...
 <?php 
$stops = $obj->StopsRecord();
 ?>                
                <tbody>
                 <?php foreach ($stops as $key => $value) { ?>
                  <tr>
                    <td><?php echo $value['stopId'] ?></td>
                    <td><?php echo $value['stopName'] ?></td>
                    <td>
                      <a class="btn btn-success btn-sm text-white" data-toggle="modal" data-target="#editstop-<?php echo $value['stopId'] ?>">Edit</a>

                      <div class="modal fade" id="editstop-<?php echo $value['stopId'] ?>" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
        ...
        <div class="modal-content">
              ...
              <div class="row">
                <div class="col-md-12"> 
                  <div class="form-group">
                    <input class="form-control" placeholder="Point Stop Name" type="hidden" name="stopId" value="<?php echo $value['stopId'] ?>">
                  </div>
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Point Stop Name" type="text" name="stopName" value="<?php echo $value['stopName'] ?>">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" name="stopUpdate">Update</button>
                            ...
                            <button class="btn btn-sm btn-danger delete" id="<?php echo $value['stopId'] ?>">Delete</button>
