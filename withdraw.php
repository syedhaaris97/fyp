        ...
        <div class="header-body">
          ...
          <!-- <div class="row"> -->
            <div class="col-md-12">
              <!-- <div class="card"> -->
                <!-- <div class="col-md-12"> -->
                 <center><h2 class="text-white">Withdraw Amount</h2></center> 
              ...
              <div class="card-body">
                <form id="withdrawForm">
                    ...
                    <div class="row justify-content-md-center">
                      <div class="col-md-6"> 
                        <div class="form-group">
                          <div id="WInput" class="input-group input-group-alternative">
                          <div class="input-group-prepend">
                              <span class="input-group-text"><i class="ni ni-money-coins text-primary"></i></span>
                          </div>
                          <input class="form-control is-valid" placeholder="New Withdraw Amount" name="" type="text" id="sBWithdraw">
                          </div>
                        </div>
                      </div>
                    </div>
                     <center><button type="submit" class="btn btn-md bg-gradient-danger text-white submitWidthdraw" id="deposit">Withdraw</button></center> 
                  </form>
              </div>
            </div>
          </div>
...
$(document).ready(function(){
  ...
  $('.submitWidthdraw').click(function(e){
    e.preventDefault();
    var sId = $('#sId').val();
    var sBWithdraw = $('#sBWithdraw').val();
   ...
   $('#modal-notification').modal('show'); 
       ...
       $('#sBWithdraw').attr('placeholder','Please Enter Amount');
    }
    else if (sBWithdraw <= 0){
      $('#WInput').css('border','2px solid crimson');
